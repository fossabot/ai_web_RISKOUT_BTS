...
function Update(){
    ...
    let [filterList] = useState([{id : 1, language: 'Python'}, {id : 2, language : 'React'}, {id : 3, language : 'Java'}, {id : 4, language :'C#'}, {id : 5, language:'C'}, {id : 6, language:'C++'}, {id : 7, language:'GO'}, {id : 8, language:'Javascript'}])
    ...
    useEffect(()=>{
        ...
        .then((res)=>res.json())
            .then((posts)=>{
                ...
                setImgURL(posts.image)
                setLanguagefilter(posts.language.split(','))
            })
            if(imgURL !== null){
                setImgGoback(true)
            }
    ...
    <> 
    {
        ...
        <section className="container-section">
            ...
            <div className="post-title">
                <textarea defaultValue={title} cols="30" rows="10" placeholder="제목을 입력하세요" onChange={(e)=>{setTitle(e.target.value)}}></textarea>
            </div>
            ...
            <div className="thumbnail_section">
                ...
                <ul>
                    ...
                    filterList.map((a)=>{
                        ...
                        if(languagefilter.indexOf(a.language) !== -1){
                            boolenChecked = true
                        }
                        return(
                        <li key={a.id}>
                            <input id={a.language} className="filters-input__checkbox" value="action" type="checkbox" data-type="genres" defaultChecked={boolenChecked}></input>
