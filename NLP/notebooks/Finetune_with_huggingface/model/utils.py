    ...
    def __init__(
        ...
        Args:
            list_of_tokens: List[str]
                list of tokens is source of vocabulary. each token is not duplicate
            padding_token: str
            ...
            token_to_idx: Dict[str, int]
                If not `None`, specifies the indices of tokens to be used by the vocabulary.
...
class Tokenizer:
    ...
    def __init__(
        ...
        Args:
            vocab (model.utils.Vocab): 
                the instance of model.utils.Vocab created from specific split_fn
            split_fn (Callable): 
                a function that can act as a splitter
            pad_fn (Callable): 
                a function that can act as a padder
        """
        self._vocab = vocab
    ...
    def __init__(self, length: int, pad_val: int = 0, clip: bool = True) -> None:
        ...
        Args:
            ...
            pad_val (int): 
                the pad value
            clip (bool): 
                whether to clip the length, if sample length is longer than maximum length
        """
        self._length = length
